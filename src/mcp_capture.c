...
static mcp_capture_notify_fn g_notify_install = NULL;
static mcp_capture_notify_fn g_notify_uninstall = NULL;
...
static struct mcp_capture_request *g_installed_req = NULL;
